...
Description:
- In this project, I implemented Principal Component Analysis to reduce the dimensionality of datasets. The project includes applying PCA to the Iris dataset and a dataset of celebrity face images (Eigenfaces) to identify principal components and reconstruct data.
