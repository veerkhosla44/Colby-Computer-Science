...
class Adaline():
    ...
    def fit(self, features, y, n_epochs=1000, lr=0.001, r_seed=None):
        ...
        self.b = float(rng.normal(0, 0.01, 1))  # Ensure scalar
        ...
        for _ in range(n_epochs):
            ...
            self.loss_history.append(float(loss))  # Ensure scalar
            self.accuracy_history.append(float(accuracy))  # Ensure scalar
